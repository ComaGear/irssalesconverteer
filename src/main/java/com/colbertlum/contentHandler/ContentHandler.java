...
import com.colbertlum.contentHandler.dataValidation.ContentHandlerValidationInterface;
...
public class ContentHandler extends DefaultHandler {
    ...
    private final ContentHandlerValidationInterface validation;
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if ("v".equals(qName)) {
            ...
            if(readingRow >= getStartDataRow()){
                validation.validateCell(column, readingRow, string);
        ...
        if ("row".equals(qName)) {
            ...
            if(readingRow == getHeaderRow()) {
                validation.validateHeader(columnHeaderMapper);
            }
    ...
    public ContentHandler(SharedStrings sharedStrings, StylesTable stylesTable, ContentHandlerValidationInterface validationInterface) {
